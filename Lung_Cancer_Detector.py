...
class LCD_CNN:
    def __init__(self,root):
        ...
        self.root.title("Lung Cancer Detector")

        img4=Image.open(r"lung.jpg")
        ...
        # title Label
        title_lbl=Label(text="Lung Cancer Detection",font=("Times New Roman",34,"bold"),bg="black",fg="white")
        title_lbl.place(x=0,y=0,width=1006,height=50)

        #button 1
        self.b1=Button(text="Import Data",cursor="hand2",command=self.import_data,font=("Times New Roman",15,"bold"),bg="black",fg="white")
        self.b1.place(x=80,y=130,width=180,height=30)

        #button 2
        self.b2=Button(text="Pre-Process Data",cursor="hand2",command=self.preprocess_data,font=("Times New Roman",15,"bold"),bg="black",fg="white")
        self.b2.place(x=80,y=180,width=180,height=30)
        self.b2["state"] = "disabled"
        self.b2.config(cursor="arrow")

        #button 3
        self.b3=Button(text="Train Data",cursor="hand2",command=self.train_data,font=("Times New Roman",15,"bold"),bg="black",fg="white")
...
# Data training is the process of training the model based on the dataset and then predict on new data.
    def train_data(self):    
        ...
        validationData = imageData[40:50]
        ...
        def network(x):
            ...
            with tf.Session() as session:
                ...
                final_accuracy=Label(text="Accuracy of the Model: " + str(x1),font=("Times New Roman",13,"bold"),bg="black", fg="white",)
